...
@section('content')
    <div class="container">
        ...
        <div class="row">
            ...
            <div>
                <form method = "POST" action="{{ url('/noticias') }}">
                @csrf
                @method('POST')
                <div class = "form-group">
                    <label for = "titulo">Título </label>
                    <input placeholder = "Digite o título do Anuncio..." type = "text" class = "form-control" value = "">  
                </div>
                <div class = "form-group">
                    <label for = "destricao"> Descrição do Anuncio</label>
                    <input placeholder = "Descricao do Anuncio...." type = "text" class = "form-control" value = "">
                </div>
                <div>
